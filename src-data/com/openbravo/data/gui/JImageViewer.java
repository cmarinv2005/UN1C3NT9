...
//        m_jbtnopen.setEnabled(value);
 //       m_jbtnclose.setEnabled(value && (m_Img != null));
    ...
    private void initComponents() {
        ...
        m_jbtnzoomout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/viewmag-1.png"))); // NOI18N
        m_jbtnzoomout.setToolTipText("Disminuir");
        m_jbtnzoomout.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jbtnzoomoutActionPerformed(evt);
            }
        });
        jPanel3.add(m_jbtnzoomout);

        m_jPercent.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        m_jPercent.setPreferredSize(new java.awt.Dimension(60, 23));
        jPanel3.add(m_jPercent);

        m_jbtnzoomin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/viewmag+1.png"))); // NOI18N
        m_jbtnzoomin.setToolTipText("Aumentar");
        m_jbtnzoomin.setAutoscrolls(true);
        m_jbtnzoomin.setMinimumSize(new java.awt.Dimension(47, 25));
        m_jbtnzoomin.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        m_jbtnzoomin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jbtnzoominActionPerformed(evt);
            }
        });
        jPanel3.add(m_jbtnzoomin);
