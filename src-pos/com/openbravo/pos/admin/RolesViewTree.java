...
// Re-instate original permissions for this role
    ...
    private void initComponents() {
        ...
        jPermissionDesc.setFont(new java.awt.Font("Calibri", 0, 20)); // NOI18N
        jPermissionDesc.setLineWrap(true);
        jPermissionDesc.setRows(5);
        jScrollPane2.setViewportView(jPermissionDesc);

        jAddEntry.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jDeleteEntry.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
