 ...
 * @author adrianromero
 */
public class ProductsWarehousePanelResumen extends JPanelTable2 {

    private JParamsLocation m_paramslocation;    
    private ProductsWarehouseEditorResumen jeditor;
    
    /** Creates a new instance of ProductsWarehousePanel */
    public ProductsWarehousePanelResumen() {
    }
    ...
    protected void init() {   
        ...
        row = new Row(
                ...
                new Field("PRICEBUY", Datas.DOUBLE, Formats.DOUBLE),  
                new Field("PRICESELL", Datas.DOUBLE, Formats.DOUBLE),              
        ...
        lpr = new ListProviderCreator(new PreparedSentence(app.getSession(),
            "SELECT L.ID, P.ID, P.REFERENCE, P.NAME, P.PRICEBUY, P.PRICESELL, P.CODE," +                  
        ...
        jeditor = new ProductsWarehouseEditorResumen(dirty);   
    }
    ...
    private class ReloadActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ProductsWarehousePanelResumen.this.bd.actionLoad();
    ...
    private class WarehouseSerializerRead implements SerializerRead {
        ...
        public Object readValues(DataRead dr) throws BasicException {
            return new Object[] {
                ...
                dr.getDouble(5),       //Compra                  
                dr.getDouble(6),       //Venta           
                dr.getString(7),       //Codigo                 
                dr.getDouble(8),       //Minimo
                dr.getDouble(9),       //Maximo        
                dr.getDouble(10)      //cantidad
            };       
        }
    }
}
